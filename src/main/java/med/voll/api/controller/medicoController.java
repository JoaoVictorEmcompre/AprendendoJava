...
public class medicoController {
    ...
    @GetMapping("/all")
    public ResponseEntity<Page<DadosListagemMedico>> listagemGeral(@PageableDefault(size = 2, sort = "nome") Pageable paginacao){
    ...
    @PutMapping("/{id}")
    @Transactional
    public ResponseEntity ativando(@PathVariable Long id){
        var medico = repository.getReferenceById(id);
        medico.ativar();
